...
public class DateInfoAdapter extends BaseAdapter {
    ...
    public DateInfoAdapter(LayoutInflater layoutInflater, ArrayList<DateModel> dateModels) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.date_info_list_item, null);
