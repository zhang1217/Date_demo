...
public class ShowNotification {
    ...
    public ShowNotification(String title, String text, String subText, int smallIcon, Bitmap lagerIcon, long when, boolean autoCanel, int defaults, int visibility) {
        this.title = title;
        this.text = text;
